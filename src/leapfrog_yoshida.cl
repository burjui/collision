...
kernel void leapfrog_yoshida(global double2 *positions, global double2 *velocities,
  ...
  const double2 a1 =
      gravity_acceleration(object_index, x1, positions, global_gravity,
  ...
  const double2 a2 =
      gravity_acceleration(object_index, x2, positions, global_gravity,
                           planet_masses, planet_count, gravitational_constant);
  const double2 v2 = v0 + a2 * (double2)(D2 * dt, D2 * dt);
  const double2 x3 = x0 + v2 * (double2)(C3 * dt, C3 * dt);
  const double2 a3 =
      gravity_acceleration(object_index, x3, positions, global_gravity,
                           planet_masses, planet_count, gravitational_constant);
