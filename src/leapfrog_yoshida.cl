...
double2 gravity_acceleration(
    ...
    constant const double *planet_masses,
    ...
    for (uint planet_index = 0; planet_index < planet_count; ++planet_index) {
        if (planet_index != object_index) {
            ...
            const double distance_squared = to_planet.x * to_planet.x + to_planet.y * to_planet.y;
...
kernel void leapfrog_yoshida(
    ...
    const double2 a1 = gravity_acceleration(
        object_index, x1, positions, global_gravity, planet_masses, planet_count, gravitational_constant);
    ...
    const double2 a2 = gravity_acceleration(
        object_index, x2, positions, global_gravity, planet_masses, planet_count, gravitational_constant);
    ...
    const double2 a3 = gravity_acceleration(
        object_index, x3, positions, global_gravity, planet_masses, planet_count, gravitational_constant);
